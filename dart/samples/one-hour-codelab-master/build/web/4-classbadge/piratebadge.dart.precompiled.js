...
["", "piratebadge.dart", , A, {
  ...
  updateBadge: [function(e) {
    ...
    t3 = t1._firstName;
    t2.textContent = t3.length === 0 ? "" : H.S(t3) + " the " + H.S(t1._appellation);
  ...
  PirateName: {
    ...
    toString$0: function(_) {
      ...
      return t1.length === 0 ? "" : H.S(t1) + " the " + H.S(this._appellation);
    },

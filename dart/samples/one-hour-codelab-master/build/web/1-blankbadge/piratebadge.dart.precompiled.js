...
["", "piratebadge.dart", , A, {
  ...
  main: [function() {
    ...
    t1 = W.HttpRequest_getString("pirateBadge.json", null, null).then$1(A.PirateName__parsePirateNamesFromJSON$closure()).then$1(new A.main_closure(inputField));
    t2 = $.Zone__current;
  ...
  updateBadge: [function(e) {
    ...
    if (t1.length === 0) {
      ...
      t2.textContent = "Aye!   Gimmie a name!";
    } else {
  ...
  main_closure0: {
    ...
    call$1: function(arrr) {
      P.print("Error initialising pirate names: " + H.S(arrr));
      $.badgeNameElement.textContent = "Arr No Names!";
    }
  },
  PirateName: {
    ...
    PirateName$fromJSON$1: function(jsonString) {
      var storedName, t1;
      storedName = H.interceptedTypeCast(C.JsonCodec_null_null.decode$1(jsonString), "$isMap");
